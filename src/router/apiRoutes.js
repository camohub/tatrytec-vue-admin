...
export default {
    ...
    ARTICLE_STORE_URL: API_URL + 'api/article/store',  // Trailing slash causes the CORS issue with redirect to url without slash.
    ...
    CATEGORY_STORE_URL: API_URL + 'api/category/store',  // Trailing slash causes the CORS issue with redirect to url without slash.
